...
* You _must_ save your work to a new file; OpenRefine _does not_ modify your original dataset. This is helpful for following best practices regarding using data (i.e., never edit the original dataset). 
